                    ...
                    <table class="Table Form-type member-tbl">
                        ...
                        <tbody>
                            ...
                            <tr>
								...
								<td>
                                    <input type="text" id="username" name="username" value="${(register.formData.username!'')}" autocomplete="username" class="Textinput Width-60" maxlength="50" data-keyfilter="-_." data-keyfilter-rule="digits|english" data-validation-rule="{required:true, numalpha:true}" data-validation-message="{required:'아이디를 입력해 주세요.'}" autofocus>
